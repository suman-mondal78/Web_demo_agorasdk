...
import "./App.css";
import { options, rtc } from "./import";
    ...
    <>
      <div className="container">
        <header className="App-Header">
          ...
          <img src= "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSaKU6t8pWB1XvEdXSBwhDJ7TGR8U7LvFshgw_lMFkPhB_be_8w&usqp=CAU"/>
        </header>
        <input
          type="text"
          ref={channelRef}
